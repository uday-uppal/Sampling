...
print("")
#Oversampling
oversample = SMOTE(sampling_strategy='minority',random_state=20)
x=data.iloc[:,:-1]
y=data.iloc[:,-1]
x_sampled,y_sampled=oversample.fit_resample(x,y)
print("After Oversampling, ",y_sampled.value_counts())
...
x_train, x_test, y_train, y_test=train_test_split(data_simpleRandomSampling.iloc[:,:-1],data_simpleRandomSampling.iloc[:,-1],test_size=0.2,random_state=20)
m1 = LogisticRegression(max_iter= 2500,random_state=20)
m2 = DecisionTreeClassifier(random_state=20)
m3 = RandomForestClassifier(random_state=20)
...
x_train, x_test, y_train, y_test=train_test_split(data_systematic.iloc[:,:-1],data_systematic.iloc[:,-1],test_size=0.2,random_state=20)
m1 = LogisticRegression(max_iter= 2500,random_state=20)
m2 = DecisionTreeClassifier(random_state=20)
m3 = RandomForestClassifier(random_state=20)
m4 = KNeighborsClassifier()
...
x_train, x_test, y_train, y_test=train_test_split(data_stratified.iloc[:,:-1],data_stratified.iloc[:,-1],test_size=0.2,random_state=20)
m1 = LogisticRegression(max_iter= 2500,random_state=20)
m2 = DecisionTreeClassifier(random_state=20)
m3 = RandomForestClassifier(random_state=20)
m4 = KNeighborsClassifier()
...
x_train, x_test, y_train, y_test=train_test_split(data_clustered.iloc[:,:-1],data_clustered.iloc[:,-1],test_size=0.2,random_state=20)
m1 = LogisticRegression(max_iter= 2500,random_state=20)
m2 = DecisionTreeClassifier(random_state=20)
m3 = RandomForestClassifier(random_state=20)
m4 = KNeighborsClassifier()
...
x_train, x_test, y_train, y_test=train_test_split(data_quotasampling.iloc[:,:-1],data_quotasampling.iloc[:,-1],test_size=0.2,random_state=20)
m1 = LogisticRegression(max_iter= 2500,random_state=20)
m2 = DecisionTreeClassifier(random_state=20)
m3 = RandomForestClassifier(random_state=20)
m4 = KNeighborsClassifier()
...
samplings=["Simple Random Sampling    ",
"Systematic Random Sampling",
"Stratified sampling       ",
"Cluster Sampling          ",
"Quota Sampling            "]
